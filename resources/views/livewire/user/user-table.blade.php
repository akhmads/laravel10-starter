<div>
    ...
    <x-hyco.table>
        ...
        <x-slot name="headingRight">
            <x-hyco.link wire:navigate href="{{ route('user.form',0) }}" icon="plus" class="scale-90">
                Create
            </x-hyco.link>
        </x-slot>
        ...
        <x-hyco.table-tr>
            ...
            <td class="h-px w-px whitespace-nowrap px-4 py-3">
                <a href="{{ route('user.form',$user->id) }}" wire:navigate class="text-xs text-white bg-blue-600 px-3 py-1 rounded-lg">Edit</a>
